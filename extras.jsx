// =====================================================================
// Extras: i18n, AuthButtons, NotificationBell, LangToggle, ProfileMenu
// + SettingsModal, DashboardModal, UpgradeModal
// =====================================================================
...
const AuthModal = ({ mode: initialMode, onClose, onLogin }) => {
  const [mode, setMode] = _us(initialMode || "login");
