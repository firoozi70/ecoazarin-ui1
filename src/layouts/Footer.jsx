...
const Footer = () => (
  <footer className="border-t border-ink-500 bg-ink-850 mt-12">
    <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-8 md:py-14 grid gap-0 md:gap-8 md:grid-cols-6 lg:grid-cols-12 content-start">
      ...
      {[
        { t: "محتوا", l: [{text:"اخبار", href:"/news.html"}, {text:"مقالات", href:"/articles.html"}, {text:"پادکست", href:"/podcasts.html"}, {text:"ژورنال نویسی", href:"/journal.html"}] },
        { t: "محصول", l: [{text:"ابزارها", href:"/tools.html"}, {text:"ماشین حساب", href:"/compound-calc.html"}, {text:"آموزش", href:"/education.html"}, {text:"چارت‌ها", href:"/charts.html"}] },
        { t: "شرکت", l: [{text:"درباره ما", href:"/about.html"}, {text:"تماس با ما", href:"/contact.html"}, {text:"استخدام", href:"/careers.html"}, {text:"حریم خصوصی", href:"/privacy.html"}] },
      ].map((c) => (
