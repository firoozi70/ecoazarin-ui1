  ...
  return (
    <section className="px-4 md:px-6 max-w-[1400px] mx-auto py-12" data-screen-label="Careers">
      <div className="bg-ink-850 light:bg-white border border-ink-500 light:border-zinc-200 rounded-3xl p-8 md:p-14 mb-12 relative overflow-hidden text-center z-0 group">
        <div className="absolute top-0 start-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-brand-red/10 light:bg-brand-red/5 rounded-full blur-[100px] -z-10 group-hover:scale-110 transition-transform duration-700 ease-out" />
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-ink-900 light:bg-zinc-50 border border-ink-500 light:border-zinc-200 rounded-3xl p-8 w-full max-w-md relative tab-anim-card">
            <button 
              ...
              className="absolute top-4 start-4 w-8 h-8 flex items-center justify-center rounded-full bg-ink-800 light:bg-zinc-50 hover:bg-ink-700 transition"
            >✕</button>
